...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* readValue is unsigned 16-bit */
    printf("Read value : %u\r\n", (unsigned)readValue);

    /* compute soil moisture — use float division */
    uint32_t soilmoist = 100 - (uint32_t)((float)readValue / 40.96f);
...
/* Put the UART putchar implementation OUTSIDE main() */
PUTCHAR_PROTOTYPE
{
